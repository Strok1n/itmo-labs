...
public class SumOfTunedInWorksDatabaseLayerCommandExecutor extends DatabaseLayerCommandExecutor {


    public SumOfTunedInWorksDatabaseLayerCommandExecutor(Connection connection)
    {
        super(connection);
    }
