...
public class RemoveLowerDatabaseLayerCommandExecutor extends DatabaseLayerCommandExecutor {



    public RemoveLowerDatabaseLayerCommandExecutor(Connection connection)
    {
        super(connection);
    }
