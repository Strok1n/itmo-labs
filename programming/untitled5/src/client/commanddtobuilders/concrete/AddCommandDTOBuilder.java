...
public class AddCommandDTOBuilder implements CommandDTOBuilder
{
    ...
    public CommandDTO buildCommandDTOFromScript(String[] fileStrings, StringIterator stringIterator, String commandArgument) throws InvalidCommandArgumentsInScriptFileException {
        ...
        if (
            ...
            System.out.println(!FieldValidators.validateLabWorkName(labWorkNameString));
            System.out.println(!FieldValidators.validateLabWorkCoordinatesX(labWorkCoordinatesXString));
            System.out.println(!FieldValidators.validateLabWorkCoordinatesY(labWorkCoordinatesYString));
            System.out.println(!FieldValidators.validateLabWorkMinimalPoint(minimalPointString));
            System.out.println(!FieldValidators.validateLabWorkTunedInWorks(tunedInWorksString));
            System.out.println(!FieldValidators.validateLabWorkDifficulty(difficultyString));
