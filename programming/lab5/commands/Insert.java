...
{
	private Map<Field, Predicate<Object>> fieldValidators;
	...
	public Insert() throws NoSuchFieldException
	{
		...
		(minimalPoint) -> (Integer.parseInt(String.valueOf(minimalPoint)) > 0 ) );
		

		this.fieldValidators.put( Coordinates.class.getDeclaredField("x"), (x) -> (true) );
		this.fieldValidators.put( Coordinates.class.getDeclaredField("y"), (y) -> (Integer.parseInt(y.toString()) > -161) );
	...
	private void handleInput(Object object, Field field)
	{
		...
		while (isInputIncorrect)
		{
				...
				field.getType().isPrimitive() )
			{
				...
				if ( !this.fieldValidators.get(field).test(value) )
				{
					this.outputStream.println(this.invalidInputMessages.get(field));
